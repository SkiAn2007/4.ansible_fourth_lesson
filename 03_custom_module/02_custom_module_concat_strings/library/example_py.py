...
def main():
    ...
    module_args = dict(
        ...
        string2=dict(required=False, type='str'),
        string3=dict(required=False, type='str')
    )
    ...
    string2 = module.params["string2"]
    string3 = module.params["string3"]
    # Вызываем нашу функцию
    lc_return = concat_strings(string1, string2, string3)
